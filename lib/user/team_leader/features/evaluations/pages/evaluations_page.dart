...
class _EvaluationsPageState extends State<EvaluationsPage>
          ...
          LayoutBuilder(builder: (context, constraints) {
            ...
            return GridView(
              ...
              children: [
                ...
                StatCard(
                  title: 'Top Score'.tr(context),
                  value: bestMember == null
                      ? 'N/A'
                ...
                StatCard(
                  title: 'Completed Tasks'.tr(context),
                  value: teamCompleted.toString(),
                  icon: Icons.task_alt_outlined,
                  accentColor: AppColors.success,
                ),
                StatCard(
                  title: 'Overdue Tasks'.tr(context),
                  value: teamOverdue.toString(),
  ...
  Widget _buildMyScoreTab(BuildContext context, MockUser? leaderMock) {
    ...
    final db = MockDatabase.instance;
    final completedTasks = db.tasks
        .where((t) => (t.currentOwnerId == leaderMock.id || (t.customAssigneeIds != null && t.customAssigneeIds!.contains(leaderMock.id))) && (t.status == 'Completed' || t.status == 'Approved'))
        .length;
