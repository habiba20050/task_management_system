                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 3.h),
                        Text(
                          'Track and manage your team\'s complaints'.tr(context),
                      ...
                      builder: (context, constraints) {
                        ...
                        return Wrap(
                          ...
                          children: [
                            ...
                            SizedBox(
                              width: w,
                              child: _statTile('Under Investigation'.tr(context), escalatedCount, Colors.orange, Icons.manage_search_outlined),
                            ),
                            SizedBox(
                              width: w,
                              child: _statTile('Team Members'.tr(context), team.memberIds.length, Colors.indigo, Icons.group_outlined),
                            ),
                          ],
                        );
                      },
                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            SizedBox(width: 8.w),
                            Text(
                              'Escalated to Manager'.tr(context),
                      ...
                      children: [
                        Expanded(
                          child: TextButton(
                            ...
                            style: TextButton.styleFrom(
                              padding: EdgeInsets.symmetric(vertical: 14.h),
                              shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(14.r), side: const BorderSide(color: Color(0xFFE2E8F0))),
                            ),
                        ...
                        if (comp.status == 'Open') ...[
                          ...
                          Expanded(
                            child: PopupMenuButton<String>(
                              ...
                              itemBuilder: (context) => [
                                PopupMenuItem(value: 'approve', child: Row(children: [Icon(Icons.check_circle, color: AppColors.success, size: 18), SizedBox(width: 8.w), Text('Approve'.tr(context))])),
                                PopupMenuItem(value: 'reject', child: Row(children: [Icon(Icons.cancel, color: AppColors.danger, size: 18), SizedBox(width: 8.w), Text('Reject'.tr(context))])),
                                PopupMenuItem(value: 'escalate', child: Row(children: [Icon(Icons.arrow_upward, color: Colors.orange, size: 18), SizedBox(width: 8.w), Text('Escalate to Manager'.tr(context))])),
                              ],
                              child: Container(
                                height: 50.h,
                                decoration: BoxDecoration(
