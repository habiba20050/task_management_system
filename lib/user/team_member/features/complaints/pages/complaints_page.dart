...
class _ComplaintsPageState extends State<ComplaintsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    // Apply search filter
    final filtered = myComplaints.where((c) {
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 3.h),
                        Text(
                          'Track and manage your submitted complaints'.tr(context),
                      ...
                      builder: (context, constraints) {
                        ...
                        return Wrap(
                          ...
                          children: [
                            ...
                            SizedBox(
                              width: w,
                              child: _statTile('Total'.tr(context), myComplaints.length, Colors.indigo, Icons.receipt_long_outlined),
                            ),
                          ],
                        );
                      },
                      ...
                      builder: (context, constraints) {
                        ...
                        return GridView.builder(
                          ...
                          itemBuilder: (context, idx) {
                            ...
                            return InkWell(
                              onTap: () => _showComplaintDetailDialog(context, comp, currentUserId),
  ...
  void _showComplaintDetailDialog(BuildContext context, MockComplaint comp, String currentUserId) {
    final statusColor = _getStatusColor(comp.status);
    final style = _categoryStyle(comp.category);
                        ...
                        child: Row(
                          ...
                          children: [
                            Icon(
                              ...
                              size: 16,
                              color: comp.status == 'Closed' ? Colors.grey : AppColors.primary,
                            ),
                            SizedBox(width: 8.w),
                            Expanded(
                              child: Text(
                                comp.status == 'Closed'
                                    ? 'This complaint has been closed.'.tr(context)
                                    : 'Your complaint is pending review.'.tr(context),
                                style: TextStyle(
                                  fontSize: 12.5.sp,
                                  fontWeight: FontWeight.bold,
                                  color: comp.status == 'Closed' ? Colors.grey : AppColors.primary,
