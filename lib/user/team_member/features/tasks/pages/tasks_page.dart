...
class _TasksPageState extends State<TasksPage> {
                  ...
                  ? Column(
                      ...
                      children: [
                        ...
                        ToggleButtons(
                          ...
                          constraints: BoxConstraints(minWidth: 52.w, minHeight: 32.h),
                          ...
                          children: [
                            Text('Table'.tr(context), style: TextStyle(fontSize: 10.sp, fontWeight: FontWeight.bold)),
                            Text('Kanban'.tr(context), style: TextStyle(fontSize: 10.sp, fontWeight: FontWeight.bold)),
                            Text('Calendar'.tr(context), style: TextStyle(fontSize: 10.sp, fontWeight: FontWeight.bold)),
                          ],
                        ),
                      ],
                    )
  ...
  // --- Filter Bar ---
  Widget _buildFilterBar(BuildContext context, String role) {
    return AppCard(
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
  ...
  Widget _buildKanbanView(List<UnifiedItem> items, String role, String currentUserId) {
    ...
    if (isMobile) {
      return SingleChildScrollView(
        ...
        child: Row(
          children: [
            SizedBox(width: 260.w, child: _buildKanbanCol('Todo'.tr(context), todo)),
            SizedBox(width: 10.w),
            SizedBox(width: 260.w, child: _buildKanbanCol('In Progress'.tr(context), inProgress)),
            SizedBox(width: 10.w),
            SizedBox(width: 260.w, child: _buildKanbanCol('Under Review'.tr(context), review)),
            SizedBox(width: 10.w),
            SizedBox(width: 260.w, child: _buildKanbanCol('Completed'.tr(context), done)),
          ],
        ),
      );
    }
