    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          const Spacer(),
          Flexible(child: Text(value, style: TextStyle(fontSize: 11.sp, fontWeight: FontWeight.bold, color: AppColors.textPrimary), textAlign: TextAlign.end, overflow: TextOverflow.ellipsis)),
        ],
      ),
    );
  }
                            ...
                            Row(
                              children: [
                                Expanded(
                                  child: Row(
                                    children: [
                                      Flexible(child: Text(comment.userName, style: TextStyle(fontWeight: FontWeight.bold, fontSize: 11.5.sp), overflow: TextOverflow.ellipsis)),
                                      SizedBox(width: 6.w),
                                      Container(
