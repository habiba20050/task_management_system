  ...
  void _buildDefaults() {
    ...
    _tasks = [
      ...
      MockTask(
        id: 'tsk9',
        ticketId: 'tic9',
        title: 'University Open Day Committee',
        description: 'Organize booths, schedule volunteers, and coordinate the university open day.',
        assignedMemberId: '3',
        deadline: '2026-08-20',
        estimatedHours: 12,
        priority: 'MEDIUM',
        ...
        currentOwnerId: '3',
        taskDepartment: 'Computer Science',
        taskType: 'Custom / Multiple',
        customAssigneeIds: ['3', '4', '5'],
      ),
      MockTask(
        id: 'tsk10',
        ticketId: 'tic10',
        title: 'Final Exam Proctoring Schedule',
        description: 'Prepare the proctoring rota for final exams across all departments.',
        assignedMemberId: '4',
        deadline: '2026-08-25',
        estimatedHours: 10,
        priority: 'HIGH',
