...
class _ComplaintsPageState extends State<ComplaintsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final complaints = MockDatabase.instance.complaints.where((c) {
      final matchesSearch = c.title.toLowerCase().contains(_searchController.text.toLowerCase()) ||
          c.description.toLowerCase().contains(_searchController.text.toLowerCase());
                ...
                children: [
                  ...
                  ElevatedButton.icon(
                    ...
                    style: ElevatedButton.styleFrom(
                      backgroundColor: const Color(0xFFFA1819),
              ...
              Container(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    prefixIcon: const Icon(Icons.search, color: Color(0xFFFA1819)),
                                  ...
                                  if (c.resolutionNotes.isNotEmpty) ...[
                                    ...
                                    Container(
                                      ...
                                      child: Text(
                                        ...
                                        style: TextStyle(color: Colors.green[800], fontSize: 13.sp),
                                      ),
                                    ),
                                  ],
                                  if (role != 'Team Member' && c.status != 'Resolved' && c.status != 'Closed') ...[
                                    const Divider(),
                                    Row(
                                      mainAxisAlignment: MainAxisAlignment.end,
                                      children: [
                                        OutlinedButton(
                                          onPressed: () => _handleUpdateComplaint(context, c.id, 'Under Investigation'),
                                          child: const Text('Investigate'),
                                        ),
                                        SizedBox(width: 12.w),
                                        ElevatedButton(
                                          onPressed: () => _handleUpdateComplaint(context, c.id, 'Resolved'),
    ...
    showDialog(
      ...
      builder: (context) => StatefulBuilder(
        builder: (context, setDialogState) => AlertDialog(
          ...
          title: const Text('Submit a Complaint', style: TextStyle(fontWeight: FontWeight.bold)),
              ...
              child: Column(
                ...
                children: [
                  ...
                  DropdownButtonFormField<String>(
                    value: targetType,
                    decoration: const InputDecoration(labelText: 'Complaint Target'),
                    items: ['Member', 'Team Leader', 'Manager', 'Team', 'Workload Issue', 'Deadline Issue']
                  ...
                  TextField(
                    ...
                    decoration: const InputDecoration(labelText: 'Target Identifier / Name', hintText: 'e.g. Sarah Ahmed, Budget Task'),
                  ),
                  SizedBox(height: 12.h),
                  TextField(
                    controller: descCtrl,
                    decoration: const InputDecoration(labelText: 'Complaint Details / Context'),
                    maxLines: 3,
                  ),
                ],
              ),
              ...
              onPressed: () {
                if (titleCtrl.text.isNotEmpty && descCtrl.text.isNotEmpty) {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(content: Text('Complaint submitted and escalated successfully.')),
                  );
                }
              },
  ...
  void _handleUpdateComplaint(BuildContext context, String complaintId, String status) {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        backgroundColor: Colors.white,
        title: Text('Update Complaint Status to: $status', style: const TextStyle(fontWeight: FontWeight.bold)),
        content: TextField(
